         ...
         <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
               <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                  <a class="navbar-brand brand-logo" href="index.php"><img src="../admin/assets/images/new_logo.jpg" alt="logo"/></a>
                  <a class="navbar-brand brand-logo-mini" href="index.php"><img src="../admin/assets/images/new_logo.jpg" alt="logo"/></a>
               </div>
            ...
            <div class="main-panel" style="width:100%;">
               ...
               <footer class="footer">
                  <div class="d-sm-flex justify-content-center justify-content-sm-between">
                     <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2024 <a href="https://www.instagram.com/sayantan077?igsh=cXRwaWp5MWxtOTAx" target="_blank">Sayantan</a>. All rights reserved.</span>
                  </div>
               </footer>
               <!-- partial -->
            </div>
